...
def verify_policy(policy_fun, args):
...
def dagger(epoch):
    ...
    for i in range(epoch):
        ...
        new_data, _ = verify_policy(policy_fun, args)
        expert_fn = load_policy(args.expert_policy_file)
        _, new_label = verify_policy(expert_fn, args)
